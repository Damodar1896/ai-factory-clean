    ...
    <body class="bg-gray-950 text-white font-sans p-6">
        <div class="max-w-xl mx-auto bg-gray-900 border border-gray-800 p-8 rounded-xl shadow-2xl mt-6">
            ...
            <div id="crypto-box" class="bg-white text-gray-900 p-6 rounded-xl text-center mb-6 hidden">
                ...
                <div class="bg-gray-100 p-2 rounded text-xs font-mono font-bold text-gray-800 break-all">
                    TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t
                </div>
                <p class="text-xs text-gray-500 mt-2">Network: TRON (TRC20 only)</p>
            </div>
        ...
        <script>
            ...
            function generateCryptoQR() {
                ...
                if(container.innerHTML === "") {
                    new QRCode(container, { text: "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t", width: 140, height: 140 });
                }
            }
...
if "@app.get(\"/checkout\")" in content:
    ...
    new_content = parts[0] + international_checkout_code
    with open("app.py", "w", encoding="utf-8") as f:
        f.write(new_content)
    print("[Success] Global Checkout (UPI + PayPal + Crypto) updated successfully!")
else:
    with open("app.py", "a", encoding="utf-8") as f:
        f.write(international_checkout_code)
    print("[Success] Global Checkout appended successfully!")

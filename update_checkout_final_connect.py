...
if "@app.get(\"/checkout\")" in content:
    ...
    new_content = parts[0] + final_checkout_html
    with open("app.py", "w", encoding="utf-8") as f:
        f.write(new_content)
    print("[Success] Checkout page updated with Copy Buttons, Backend Fetch, and SSL badges!")
